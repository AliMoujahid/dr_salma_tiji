...
async function seed() {
    try {
        ...
        const doctor = await User_1.default.create({
        ...
        const receptionist = await User_1.default.create({
        ...
        const config = await ClinicConfig_1.default.create({
        ...
        // Create Patients
        const patients = await Patient_1.default.create([
            {
        ...
        await ToothHistory_1.default.create([
            {
                patientId: amine._id,
                toothNumber: 14,
                status: 'Crown',
        ...
        const invoice1 = await Invoice_1.default.create({
        ...
        const invoice2 = await Invoice_1.default.create({
        ...
        const appts = await Appointment_1.default.create([
            {
